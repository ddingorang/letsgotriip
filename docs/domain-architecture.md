...
| 단계 | 포함 도메인 | 이유 |
|---|---|---|
| **MVP 필수** | 사용자·인증, 관광 콘텐츠 탐색, 여행 계획, AI 추천, 데이터/취향 일부 | 기본 흐름: 가입 → 탐색 → 추천 → 계획 저장 |
| **MVP 보강** | 여행 평가·최적화, 체크리스트, 여행 맥락 정보 일부 | 계획 품질·실사용성 강화 |
| **1차 확장** | 커뮤니티·UGC, 축제/행사, 마이페이지·앨범 | 체류·콘텐츠 축적 |
| **2차 확장** | 동행·그룹·단체할인, 게임화 고도화, 운영 백오피스 | 네트워크 효과·장기 운영 |
