...
public class DataSeeder implements ApplicationRunner {
    ...
    /** 제주 위경도 기준 핫플 4건 (HotPlaceService.register → 자동 APPROVED) */
    ...
    private void register(Long userId, String name, String address,
                          double lat, double lng, HotPlaceCategory category, String desc) {
        hotPlaceService.register(userId, new HotPlaceCreateRequest(
                name, address, lat, lng, category, desc, List.of()));
    }
