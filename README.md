...
🖼️ 발표 PPT : [PDF(링크)](https://drive.google.com/file/d/1K7vEBuUFEfydfMdPHAPK40Ak7iSBcYkz/view?usp=sharing)  |  :video_camera: 시연 영상 : [MP4(링크)](https://drive.google.com/file/d/1U2dRGCUB3DZySbhjIblqUcKAEN8js3f3/view?usp=sharing)
...
<img width="1772" height="913" alt="image" src="https://github.com/user-attachments/assets/063ac33b-26aa-4704-8134-30f248c4cdc4" />
...
| **Messaging** | ![Spring AMQP](https://img.shields.io/badge/Spring%20AMQP-FF6600?style=for-the-badge&logo=rabbitmq&logoColor=white) ![WebSocket STOMP](https://img.shields.io/badge/WebSocket%20%2F%20STOMP-4A4A4A?style=for-the-badge) |
| **Batch** | ![Spring Batch](https://img.shields.io/badge/Spring%20Batch-6DB33F?style=for-the-badge&logo=spring&logoColor=white) |
| **Documentation** | ![Swagger](https://img.shields.io/badge/Swagger-springdoc%202.8.13-85EA2D?style=for-the-badge&logo=swagger&logoColor=black) |
| **ETC** | ![Lombok](https://img.shields.io/badge/Lombok-BC4521?style=for-the-badge) ![spring-dotenv](https://img.shields.io/badge/spring--dotenv-4A4A4A?style=for-the-badge) ![TSID](https://img.shields.io/badge/TSID-4A4A4A?style=for-the-badge) |
...
| **Build** | ![Vite](https://img.shields.io/badge/Vite-8-646CFF?style=for-the-badge&logo=vite&logoColor=white) |
| **State Management** | ![Pinia](https://img.shields.io/badge/Pinia-3-FFD859?style=for-the-badge&logo=pinia&logoColor=black) |
| **Routing** | ![Vue Router](https://img.shields.io/badge/Vue%20Router-5-4FC08D?style=for-the-badge&logo=vuedotjs&logoColor=white) |
| **HTTP** | ![Axios](https://img.shields.io/badge/Axios-1.18-5A29E4?style=for-the-badge&logo=axios&logoColor=white) |
| **Real-Time** | ![STOMP.js](https://img.shields.io/badge/%40stomp%2Fstompjs-7-4A4A4A?style=for-the-badge) |
| **Maps** | ![Kakao Maps](https://img.shields.io/badge/Kakao%20Maps%20SDK-FFCD00?style=for-the-badge&logo=kakao&logoColor=black) |
...
| 분류 | 기술 |
|---|---|
| **DB** | ![MySQL](https://img.shields.io/badge/MySQL-8.0-4479A1?style=for-the-badge&logo=mysql&logoColor=white) ![MongoDB](https://img.shields.io/badge/MongoDB-7.0-47A248?style=for-the-badge&logo=mongodb&logoColor=white) ![redis-stack](https://img.shields.io/badge/redis--stack-RediSearch-DC382D?style=for-the-badge&logo=redis&logoColor=white) |
| **Cache / Session** | ![Redis](https://img.shields.io/badge/Redis-7.2-DC382D?style=for-the-badge&logo=redis&logoColor=white) |
| **Broker** | ![RabbitMQ](https://img.shields.io/badge/RabbitMQ-3.12-FF6600?style=for-the-badge&logo=rabbitmq&logoColor=white) |
...
- MySQL 스키마 `trip_chat` — 총 **38개 도메인 테이블** + Spring Batch 메타 테이블 9개
- 채팅 메시지 본문만 MongoDB(`chat_messages`)에 저장
...
### 경로 규칙
- 대부분 `/api/**` 프리픽스를 사용하되, **`/auth`, `/users`, `/community`, `/companion`, `/analysis`는 프리픽스 없이** 노출(초기 구현 경로 유지)
- 응답은 envelope 없이 `ResponseEntity<Dto>` 직접 반환. 에러만 `ErrorResponse { code, message }`로 통일
...
- 계획에 장소를 담는 순간 `attractions` 테이블에 upsert하여 **스냅샷으로 영속화**
    - 계획 데이터가 외부 API 변동·장애에 영향을 받지 않음
...
- TourAPI 축제 데이터를 **하루 2회(06/18시 KST) 동기화**하고 종료된 축제를 정리
