...
export const useHotplaceStore = defineStore('hotplace', () => {
  ...
  const hotplaces = ref([
    ...
    { id: 3, name: '사려니 숲길 입구', category: '명소', location: '제주 제주시 조천읍', address: '제주 제주시 조천읍 교래리 산 137-1', rating: 4.9, ratingCount: 212, saveCount: 297, description: '숲길 입구', lat: 33.4173, lng: 126.6620, registrant: '숲속산책', registeredAt: '3일 전', intro: '신비로운 사려니 숲길의 시작점이에요. 이른 아침 안개가 낀 숲길이 특히 아름답습니다.' },
  ])
