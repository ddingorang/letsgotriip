...
const SERVICE_KEY = '73c339a232ae3d694d3f76d524933ae3fda8c253c457a71fa3cf0bfe73609c7c';
...
export async function fetchFestivals({ areaCode = '' } = {}) {
  ...
  // flat error format (KorService2가 파라미터 오류 등을 반환할 때)
